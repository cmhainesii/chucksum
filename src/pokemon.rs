...
impl Pokemon {
    ...
    pub fn from_raw(raw: PokemonRaw) -> Pokemon {
        ...
        Pokemon {
            ...
            attack: raw.u16_be(offsets::PARTY_ATTACK),
            defense: raw.u16_be(offsets::PARTY_DEFENSE),
            speed: raw.u16_be(offsets::PARTY_SPEED),
            special: raw.u16_be(offsets::PARTY_SPECIAL),
        }
    }
